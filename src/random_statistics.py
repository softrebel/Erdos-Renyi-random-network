...
def calculate_by_lambert(mean_k):
...
def calculate_by_curves_intersections(mean_k):
...
def get_statistics_of_random_network(N,mean_k):
    ...
    s_lambert=calculate_by_lambert(mean_k)
    print("calculate from lambert w function:")
    print(f"S = {s_lambert}")
    s_curves_intersections=calculate_by_curves_intersections(mean_k)
    print("intersections of curves:")
    ...
    kmax=calculate_kmax_from_guess(N,mean_k)
    print(f"k_max = {kmax}")

    return (s_lambert,*s_curves_intersections)
